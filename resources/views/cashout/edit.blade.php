...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form method="POST" action="{{route('cashout.update', ['cashout' => $cashout->id])}}">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            placeholder="Amount" 
                            name="amount" 
                            value="{{ old('amount') ? old('amount') : $cashout->amount}}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <select class="form-control form-control-Currency @error('currency') is-invalid @enderror" name="currency">
                            ...
                            @foreach ($currencies as $currency)
                                <option value="{{$currency->currency_name}}" 
                                    {{old('currency') ? ((old('currency') == $currency->currency_name) ? 'selected' : '') : (($currency->currency_name == $currency->currency_name) ? 'selected' : '')}}>
                     ...
                     <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="details" 
                            value="{{ old('details') ? old('details') : $cashout->details}}">
