              ...
              public function calculator()
              {
                ...
                $row= DB::table('currencies')
                 ...
                 $flat_rate= DB::table('flate_rates')
                   ...
                   return view('agent.calculator', ['countries'=>$countries,'currencies'=>$currencies,'rate'=>$rate,'flate_rates'=>$flat_rate,'pricing_plan'=>$pricing_plan,'percentage'=>$percentage,'user_currency'=>$user_currency,'balance'=> $balance,'request'=>$request,'country'=> $country]);
              }
